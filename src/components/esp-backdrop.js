...
// @element esp-backdrop
export default class EspBackdrop extends HTMLElement {
  static #shadowStyleSheet = css`
    :host {
      ...
      touch-action: none;
      cursor: default;
      background: var(--esp-color-background);
    }
    :host([hidden]) {
      display: none;
    }
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [EspBackdrop.#shadowStyleSheet];
...
customElements.define("esp-backdrop", EspBackdrop);
